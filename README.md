# IScript BrowserExtension (Firefox)
...
### 理念
「シンプル」「直観的」「高い移植性」「低い開発コスト」をコンセプトに開発されています。<br>
抽象化されたすべての命令・文法は、後方互換性を保証されています。
...
### 構文
構文については、[公式ドキュメント](https://abatbeliever.net/docs/IScript/)を参照ください。
